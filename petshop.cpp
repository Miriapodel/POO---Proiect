...
class Discount
{
    ...
    public:
        ...
        void setProcent(const int input)
        {
            procent = input;
        }

        void setCategorie(const char input[])
        {
...
class Adresa
{
    ...
    public:
        ...
        Adresa(const string strada, const int numar_strada,
               const int numar_locuinta, const string blocul = "_",
               const string scara = "_")
        {
            this->strada = strada;
            this->blocul = blocul;
            this->scara = scara;
        ...
        void setStrada(const string input)
        {
            strada = input;
        }

        void setBlocul(const string input)
        {
            blocul = input;
        }

        void setScara(const char input)
        {
            scara = input;
        }

        void setNumar_Strada(const int input)
        {
            numar_strada = input;
        }

        void setNumar_Locuinta(const int input)
        {
...
class Produs : public Prod_baza
{
    ...
    public:
        ...
        Produs(const char nume[], const char categorie[], const float pret, const char descriere[] = "_")
        {
        ...
        void setNume(const char input[])
        {
            strcpy(nume, input);
        }

        void setDescriere(const char input[])
        {
        ...
        void setPret(const float input)
        {
            pret = input;
        }
...
class ProdusPerisabil : virtual public Produs
{
    ...
    public:
        ...
        ProdusPerisabil(const char nume[], const char categorie[], const float pret, const char descriere[] = "_"):Produs(nume, categorie, pret, descriere)
        {
            expira = 1;
        }

        void set_expira(const bool val)
        {
            expira = val;
        }
...
class ProdusOnSale : virtual public Produs
{
    ...
    public:
        ...
        ProdusOnSale(const char nume[], const char categorie[], const float pret, const double reducere, const char descriere[] = "_"):Produs(nume, categorie, pret, descriere)
        {
        ...
        void set_reducere(const double val)
        {
            reducere = val;
        }
...
class ProdusPerisabilOnSale : public ProdusPerisabil, public ProdusOnSale
{
    public:
        ...
        ProdusPerisabilOnSale(const char nume[], const char categorie[], const float pret, const char descriere[] = "_"):Produs(nume, categorie, pret, descriere)
        {
...
auto lambda = [](float& sum, const int nr, const vector<Produs*> p)
{
    sum = 0;
...
class Inventar
{
    ...
    public:
        ...
        void adauga_produs(Produs* const p);
        void adauga_produs_bonus(Produs* const p);
...
void Inventar::adauga_produs(Produs* const p)
{
    produse.push_back(p);
   numar_produse++;
}

void Inventar::adauga_produs_bonus(Produs* const p)
{
...
class Cos
{
    ...
    public:
        ...
        void adauga_produs(Produs* const produs);
        void scoate_produs(const int pozitie);
        void valoare_dupa_discount();
        void adaugare_discount(const int procent, const char categorie[]);
        void afisare_produse_cos();
        void reducere_mediu();
        void valoare_cos();
        template<typename Lambda>
        void valoare_produse(const Lambda exp)
        {
            exp(suma_totala, numar_produse, produse);
        }

        template<>
        void valoare_produse<Discount>(const Discount exp)
        {
...
void Cos::adaugare_discount(const int procent, const char categorie[])
{
...
class Utilizator
{
    ...
    public:
        ...
        Utilizator(const char username[], const char parola[], const char email[] = "_", const char nume[] = "_", const char prenume[] = "_")
        {
            adrese = NULL;
            numar_adrese = 0;
            strcpy(this->nume, nume);
        ...
        void setPrenume(const char input[])
        {
        ...
        void setParola(const char input[])
        {
            strcpy(parola, input);
        }
        ...
        void sterge_adresa(const int pozitie);
        void afisare_adrese();
...
void Utilizator::sterge_adresa(const int pozitie)
{
    if ( adrese != NULL )
    {
...
void testare()
{
    const shared_ptr<Inventar> ref_inv = Inventar::getInstance();
...
//TODO: Factory Method
//TODO: Template class Discount -> categorie sa fie type T
// TODO: Sa nu pot sa copiez utilizatorul
